...
\begin{figure}[H]
    ...
    \vspace{20pt}
    \subfigure[\centering 180 MHz unmodified]{{\includegraphics[width=0.495\linewidth]{./figures/superfish/superfish180_z_highlighted.png} }}%
    \vspace{20pt}
...
\begin{figure}[H]
    ...
    \vspace{20pt}
    \subfigure[\centering 180 MHz truncated]{{\includegraphics[width=.5\textwidth]{./figures/superfish/superfish180mod_z_highlighted.png} }}%
    \vspace{20pt}

...
For example, high-energy beams (5–10 MeV) are used in medical accelerators and provide services such as medical device sterilization and food irradiation;
with medium energy devices (400 keV–5 MeV) wires, cables and tires are improved, factory flue gases or wastewater can be treated.
...
It that was developed in 1989 and was named \textit{Rhodotron} \cite{rhodo_pottier}. This name was trademarked by \textit{IBA Group} in the following years. 
...
\end{equation}
where $P$ is the dissipated power, $\phi$ is the phase lag, typically taken as $15^\circ$ \cite{rhodo_pottier}. 
...
Simulation frame after a simulation run has been completed can be observed in \fromfig{gui_simulate_1} of \fromapp{supp}.
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{./figures/rhodoSim/GUI_analyze_Edist.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{./figures/rhodoSim/GUI_sweep_muE.png}
    \caption{Sweep frame of \textit{GUI} \\ $\phi_{lag}$ $\mu E$ result.}
    \label{fig:gui_sweep_muE}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{./figures/rhodoSim/GUI_sweep_sE.png}
...
Complementary bending magnet design will be the first challange of \textit{Rhodotron Simulation}, which will provide tremendous testing and improvement opportunuties.

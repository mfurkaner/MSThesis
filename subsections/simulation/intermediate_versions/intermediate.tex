...
\begin{figure}[H]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \end{minted}
    \end{subfigure}
    \caption{* and \% operators of vector3d class.}
...
\begin{figure}[H]
    ...
    \begin{minted}[linenos=false, autogobble, frame=lines, framesep=2mm, fontsize=\tiny, style=staroffice]{c++}
        ...
        thcount=10     
    \end{minted}
\caption{An example config.in file.}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Leap-frog data on \\$E_{in}=1$MeV, \textbf{B}=$0.1$T, $t_{end}=5$ns}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{RK4-2} data on \\$E_{in}=1$MeV, \textbf{B}=$0.1$T, $t_{end}=5$ns}

...
In the \fromfig{gui_config}, the implemented version of \fromfig{gui_illustration} can be observed. This version of the \textit{GUI} 
\begin{itemize}
    \item[Configuration Frame] provides an interface for specifying, saving or loading a configuration.
    \item[Simulation Frame] provides an interface for starting and managing the \textit{simulation engine}, displaying the progress of the simulation.
    \item[Render Frame] provides an interface for rendering the results of a simulation.
    \item[Analyze Frame] provides an interface for analyzing the results of a simulation.  
    \item[Sweep Frame] provides an interface for parameter sweep functionality. 
\end{itemize}

\subsubsection{Configuration Frame}
This frame consists of $\vecthreeBF{B}$ field, $\vecthreeBF{E}$ field, \textit{RF} description, \egun, \textit{simulation} configuration regions.
...
This frame spawns the \textit{simulation engine}, configures and starts the simulation. 
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{../../../figures/rhodoSim/GUI_simulate_frame.png}
...
\begin{figure}
    ...
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[angle=270,origin=c,width=\linewidth]{../../../figures/rhodoSim/GUI_render_frame_1.png}
    \end{subfigure} 
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[angle=270,origin=c,width=\linewidth]{../../../figures/rhodoSim/GUI_render_frame_2.png}
    \end{subfigure} 

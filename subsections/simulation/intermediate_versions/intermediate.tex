...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[width=0.5\linewidth]{../../../figures/analiz/staticE_lf_rk2_dt-E.png}
        \caption*{$dt$ vs $\Delta E$}
    \end{subfigure}
    
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[width=0.5\linewidth]{../../../figures/analiz/staticE_lf_rk2_dt-Tsim.png}
        \caption*{$dt$ vs $T_{sim}$}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[width=0.5\linewidth]{../../../figures/to_be_added.png}
        \caption*{$dt$ vs $\Delta E$}
    \end{subfigure}
...
An exapmle of this configuration file can be found in \fromfig{config_file} of \fromapp{example_simulation_runs}. 

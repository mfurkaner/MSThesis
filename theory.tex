...
\begin{figure}[H]
    ...
    \caption{Technical drawing of bottom part cross section of the cavity. \\ Courtesy of Mr. Sinan Ã–z}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[angle=270,origin=c, width=.98\linewidth]{./figures/teknikcizim/Rho-A1.0.00.pdf}
    \caption{Technical drawing of the rhodotron cavity. \\ Courtesy of Mr. Sinan Ã–z}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[angle=270,origin=c, width=.98\linewidth]{./figures/teknikcizim/Rho-A1.1.00.pdf}
    \caption{Technical drawing of upper part of the cavity. \\ Courtesy of Mr. Sinan Ã–z}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[angle=270,origin=c, width=.98\linewidth]{./figures/teknikcizim/Rho-A1.2.00.pdf}
    \caption{Technical drawing of middle part of the cavity which contains the beam line. \\ Courtesy of Mr. Sinan Ã–z}
\end{figure}
